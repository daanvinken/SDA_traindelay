# histogram showing amount of delayed stops per weekday at 5pm
...
print("calculated p-value from normal distribution with calculated delayed mean and standard deviation is %s (rejection!!)" % (p))
